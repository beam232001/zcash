...
void GenerateAlertTests()
{
    ...
    // More tests go here ...
    alert.setSubVer.insert(std::string("/BeanStalk:0.1.0/"));
    alert.strStatusBar  = "Alert 1 for BeanStalk 0.1.0";
    SignAndSerialize(alert, sBuffer);

    alert.setSubVer.insert(std::string("/BeanStalk:0.2.0/"));
    alert.strStatusBar  = "Alert 1 for BeanStalk 0.1.0, 0.2.0";
    SignAndSerialize(alert, sBuffer);
    ...
    ++alert.nID;
    alert.strStatusBar  = "Alert 2 for BeanStalk 0.1.0";
    alert.setSubVer.insert(std::string("/BeanStalk:0.1.0/"));
    SignAndSerialize(alert, sBuffer);
...
BOOST_AUTO_TEST_CASE(AlertApplies)
{
    ...
    BOOST_CHECK(alerts[0].AppliesTo(1, "/BeanStalk:11.11.11/"));

    BOOST_CHECK(alerts[1].AppliesTo(1, "/BeanStalk:0.1.0/"));
    BOOST_CHECK(alerts[1].AppliesTo(999001, "/BeanStalk:0.1.0/"));

    BOOST_CHECK(alerts[2].AppliesTo(1, "/BeanStalk:0.1.0/"));
    BOOST_CHECK(alerts[2].AppliesTo(1, "/BeanStalk:0.2.0/"));
    ...
    BOOST_CHECK(!alerts[1].AppliesTo(1, "BeanStalk:0.1.0/"));
    BOOST_CHECK(!alerts[1].AppliesTo(-1, "/BeanStalk:0.1.0/"));
    BOOST_CHECK(!alerts[1].AppliesTo(999002, "/BeanStalk:0.1.0/"));
    BOOST_CHECK(!alerts[1].AppliesTo(1, "/BeanStalk:0.2.0/"));

    BOOST_CHECK(!alerts[2].AppliesTo(1, "/BeanStalk:0.3.0/"));
