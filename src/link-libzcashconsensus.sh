/bin/sh ../libtool  --tag=CXX   --mode=link g++  -std=c++11 \
	...
	-rpath ~/zcash/depends/x86_64-pc-mingw64/lib \
	...
	-lcrypto -L~/zcash/depends/x86_64-pc-mingw64/lib \
